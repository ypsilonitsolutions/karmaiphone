...
typedef enum {
  ...
  MDVariableRevealWidth
} MDViewWidthLayout;

/** @constant MDSide side of screen */
typedef enum {
  /** Left side of screen */
  MDLeft,
...
/** @constant MDResetStrategy top view behavior while anchored. */
typedef enum {
...
/** MDSlidingViewController is a view controller container that presents its child view controllers in two layers. The top layer can be panned to reveal the layers below it. */
@interface MDSlidingViewController : UIViewController{
...
/** Specifies the behavior for the under left width
 ...
 By default, this is set to MDFullWidth
 */
@property (nonatomic, assign) MDViewWidthLayout underLeftWidthLayout;

/** Specifies the behavior for the under right width
 
 By default, this is set to MDFullWidth
 */
@property (nonatomic, assign) MDViewWidthLayout underRightWidthLayout;

/** Returns the strategy for resetting the top view when it is anchored.
 
 By default, this is set to MDPanning | MDTapping to allow both panning and tapping to reset the top view.
 
 If this is set to MDNone, then there must be a custom way to reset the top view otherwise it will stay anchored.
 */
@property (nonatomic, assign) MDResetStrategy resetStrategy;
...
/** Slides the top view in the direction of the specified side.
 ...
 A peek amount or reveal amount must be set for the given side. The top view will anchor to one of those spMDified values.
...
/** Convience method for getting access to the MDSlidingViewController instance */
